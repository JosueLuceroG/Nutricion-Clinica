...
import { validatePatientPhotoValue } from "../../pacientes/patientPhoto.js";
...
function jsonParse(value: unknown): unknown {
  ...
  try {
    ...
    console.warn("[sync] jsonParse falló; devolviendo string crudo", {
      error: err,
    });
    return value;
  }
...
const pacientesMap: EntityColumnMap = {
  byClientField: {
    responsible_professional_id: {
      dbColumn: "profesional_titular_id",
      sqlType: () => sql.UniqueIdentifier(),
      nullable: true,
    },
    first_name: {
      dbColumn: "nombres",
      sqlType: () => sql.NVarChar(120),
      nullable: false,
    },
    last_name: {
      dbColumn: "apellido_paterno",
      sqlType: () => sql.NVarChar(80),
      nullable: false,
    },
    second_last_name: {
    ...
    secondary_phone: {
      dbColumn: "telefono_secundario",
      sqlType: () => sql.NVarChar(40),
      nullable: true,
    },
    whatsapp_enabled: {
      dbColumn: "whatsapp_habilitado",
      sqlType: () => sql.Bit(),
      nullable: true,
    },
    external_record_number: {
      dbColumn: "numero_expediente_externo",
      sqlType: () => sql.NVarChar(100),
      nullable: true,
    },
    admission_reason: {
      dbColumn: "motivo_ingreso",
    ...
    emergency_contact_relationship: {
      dbColumn: "contacto_emergencia_parentesco",
      sqlType: () => sql.NVarChar(60),
      nullable: true,
    },
    emergency_contact_phone: {
      dbColumn: "contacto_emergencia_telefono",
      sqlType: () => sql.NVarChar(40),
      nullable: true,
    },
    general_notes: {
      dbColumn: "notas_generales",
      sqlType: () => sql.NVarChar(sql.MAX),
      nullable: true,
    },
    estado_expediente: {
      dbColumn: "estado_expediente",
      sqlType: () => sql.NVarChar(20),
      nullable: false,
    },
    record_opened_at: {
      dbColumn: "expediente_abierto_at",
      sqlType: () => sql.DateTime2(),
      nullable: true,
      transform: toDate,
    },
    consentimiento_informado_id: {
      dbColumn: "consentimiento_informado_id",
      sqlType: () => sql.UniqueIdentifier(),
      nullable: true,
    },
    fecha_firma_consentimiento: {
      dbColumn: "fecha_firma_consentimiento",
      sqlType: () => sql.DateTime2(),
      nullable: true,
      transform: toDate,
    },
    version_politica_privacidad: {
      dbColumn: "version_politica_privacidad",
      sqlType: () => sql.NVarChar(40),
      nullable: true,
    },
    clinical_tags: {
      dbColumn: "clinical_tags_json",
      sqlType: () => sql.NVarChar(sql.MAX),
      nullable: true,
...
pacientesMap.writableDbColumns = new Set(
  Object.values(pacientesMap.byClientField).map((c) => c.dbColumn),
);
...
const consultasMap: EntityColumnMap = {
  byClientField: {
    patient_id: {
      dbColumn: "paciente_id",
      sqlType: () => sql.UniqueIdentifier(),
      nullable: false,
    },
    profesional_id: {
      dbColumn: "profesional_id",
      sqlType: () => sql.UniqueIdentifier(),
      nullable: false,
    },
    consultation_number: {
      dbColumn: "consultation_number",
      sqlType: () => sql.Int(),
      nullable: false,
    },
    consultation_date: {
      dbColumn: "consultation_date",
      sqlType: () => sql.DateTime2(),
      nullable: false,
      transform: toDate,
    },
    ...
    anthropometry_id: {
      dbColumn: "anthropometry_id",
      sqlType: () => sql.UniqueIdentifier(),
      nullable: true,
    },
    lab_panel_id: {
      dbColumn: "lab_panel_id",
      sqlType: () => sql.UniqueIdentifier(),
      nullable: true,
    },
    next_visit_date: {
      dbColumn: "next_visit_date",
      sqlType: () => sql.Date(),
      nullable: true,
      transform: toDate,
    },
...
consultasMap.writableDbColumns = new Set(
  Object.values(consultasMap.byClientField).map((c) => c.dbColumn),
);
...
antropometriasMap.byDbColumn = invertByClientField(
  antropometriasMap.byClientField,
);
antropometriasMap.writableDbColumns = new Set(
  Object.values(antropometriasMap.byClientField).map((c) => c.dbColumn),
);
...
labPanelsMap.writableDbColumns = new Set(
  Object.values(labPanelsMap.byClientField).map((c) => c.dbColumn),
);
...
const planesMap: EntityColumnMap = {
  byClientField: {
    ...
    kcal_target: {
      dbColumn: "kcal_target",
      sqlType: () => sql.Int(),
      nullable: false,
    },
    protein_target_g: {
      dbColumn: "protein_target_g",
      sqlType: () => sql.Int(),
      nullable: false,
    },
    carbs_target_g: {
      dbColumn: "carbs_target_g",
      sqlType: () => sql.Int(),
      nullable: false,
    },
    fat_target_g: {
      dbColumn: "fat_target_g",
      sqlType: () => sql.Int(),
      nullable: false,
    },
    meals: {
...
planesMap.writableDbColumns = new Set(
  Object.values(planesMap.byClientField).map((c) => c.dbColumn),
);
...
const adherenceRecordsMap: EntityColumnMap = {
  byClientField: {
    ...
    adherence_menu: {
      dbColumn: "adherence_menu",
      sqlType: () => sql.Decimal(5, 2),
      nullable: false,
    },
    adherence_water: {
      dbColumn: "adherence_water",
      sqlType: () => sql.Decimal(5, 2),
      nullable: false,
    },
    adherence_activity: {
      dbColumn: "adherence_activity",
      sqlType: () => sql.Decimal(5, 2),
      nullable: false,
    },
    adherence_supplements: {
      dbColumn: "adherence_supplements",
      sqlType: () => sql.Decimal(5, 2),
      nullable: false,
    },
    adherence_sleep: {
      dbColumn: "adherence_sleep",
      sqlType: () => sql.Decimal(5, 2),
      nullable: false,
    },
    hunger_avg: {
    ...
    intercurrent_events: {
      dbColumn: "intercurrent_events",
      sqlType: () => sql.NVarChar(1000),
      nullable: false,
    },
    barriers: {
      dbColumn: "barriers",
    ...
    facilitators: {
      dbColumn: "facilitators",
      sqlType: () => sql.NVarChar(1000),
      nullable: false,
    },
    meals_logged: {
      dbColumn: "meals_logged",
      sqlType: () => sql.NVarChar(2000),
      nullable: false,
    },
    notes: {
      dbColumn: "notes",
    ...
    submitted_by_token_id: {
      dbColumn: "submitted_by_token_id",
      sqlType: () => sql.UniqueIdentifier(),
      nullable: true,
    },
    deleted_at: {
...
adherenceRecordsMap.byDbColumn = invertByClientField(
  adherenceRecordsMap.byClientField,
);
adherenceRecordsMap.writableDbColumns = new Set(
  Object.values(adherenceRecordsMap.byClientField).map((c) => c.dbColumn),
);

/* ----------------------------- registry ----------------------------- */

function invertByClientField(
  byClient: Readonly<Record<string, ColumnSpec>>,
...
export function dbRowToClient(
  ...
  for (const spec of Object.values(map.byClientField)) {
    ...
    const clientField = Object.entries(map.byClientField).find(
      ([, s]) => s.dbColumn === spec.dbColumn,
    )?.[0];
    if (clientField) {
