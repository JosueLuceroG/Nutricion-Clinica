...
const consultasMap: EntityColumnMap = {
  byClientField: {
    ...
    payment_status: { dbColumn: 'payment_status', sqlType: () => sql.NVarChar(20), nullable: true },
    payment_concept: { dbColumn: 'payment_concept', sqlType: () => sql.NVarChar(40), nullable: true },
    ...
    amount_paid: { dbColumn: 'amount_paid', sqlType: () => sql.Decimal(12, 2), nullable: true },
    deleted_at: { dbColumn: 'deleted_at', sqlType: () => sql.DateTime2(), nullable: true, transform: toDate },
  },
  byDbColumn: {},
  writableDbColumns: new Set(),
